...
from .dependencies import ObjectDetection,register_model,Weights,WeightsEnum,_ovewrite_value_param,handle_legacy_interface,resnet50,ResNet50_Weights
...
def fasterrcnn_resnet50_fpn(
    ...
    **kwargs: Any,
    ...
    model = FasterRCNN(backbone, num_classes=num_classes,angle_step_size=angle_step_size,prediction_method=prediction_method, **kwargs)
    ...
    if hasattr(model.roi_heads, "angle_predictor"):
        nn.init.normal_(model.roi_heads.angle_predictor.weight, std=0.01)
        nn.init.constant_(model.roi_heads.angle_predictor.bias, 0)
